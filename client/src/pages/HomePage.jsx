...
const HomePage = () => {
  ...
  return (
  <div className="relative min-h-screen bg-[#e8e8e8] dark:bg-[#000] text-[#431363] dark:text-purple-300 overflow-hidden">
    ...
    <div className="px-4 sm:px-10 lg:px-28 mt-10">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center w-full mb-2 text-purple-900 dark:text-purple-300 bg-e8e8e8 dark:bg-black/40 rounded-lg px-4 py-2 inline-block mx-auto backdrop-blur-sm">
        Explore&nbsp;By&nbsp;Category
      </h2>
      ...
      <div className="flex justify-end w-full mb-8 sm:mb-10">
        <div className="relative w-full sm:w-80">
          <input
            ...
            className="w-full pl-12 pr-4 py-2 bg-[#e2e4ed] dark:bg-[#000000] rounded-full border border-gray-300 dark:border-gray-600 focus:outline-none focus:border-gray-500 shadow-sm focus:shadow-md transition-all duration-300 ease-in-out text-sm text-black dark:text-white"
          />
