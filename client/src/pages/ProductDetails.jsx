...
// FIXED: Chat handler that actually creates the chat
const handleChat = async () => {
  try {
    ...
    try {
      // FIXED: Actually create the chat via API call
      ...
      if (response.data) {
        ...
        navigate("/chat", { 
          state: { 
            ...
            productId: product._id,
            chatId: response.data.id // Pass the chat ID for immediate loading
          } 
        });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            {/* FIXED: Single Chat Button with working handlers */}
            <div className="space-y-3 pt-4">
              ...
              {/* Secondary Actions with working handlers */}
            ...
            {/* REMOVED: Duplicate Seller Info Section with chat button */}
            {/* Seller Info - Display only, no duplicate chat button */}
            {product.sellerId && (
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
